...
Input_data = "/Users/radhikashroff/Desktop/data1/train"
preprocessed_data = "/Users/radhikashroff/Desktop/data1/data_resized"
...
image1 = array(Image.open("/Users/radhikashroff/Desktop/data1/data_resized" + "/" + preprocessedlist[0]))
m,n = image1.shape[0:2]
imagepreprocessedlist = len(preprocessedlist)
    
print imagepreprocessedlist

imagematrix = array([array(Image.open("/Users/radhikashroff/Desktop/data1/data_resized"+ '/' +image2)).flatten()
...
resized_Image = imagematrix[5].reshape(img_rows, img_cols)  #reshaping the images
